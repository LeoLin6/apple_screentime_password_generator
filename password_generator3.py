...
def output_password(target_indices, random_string, string_length):     # Initialize state variables
    digits_on_screen = 0
...
def main():
    ...
    #we print out the password with the memory erasure technique
    output_password(target_indices, random_string, string_length)
   
    #we print out the password again to reenter it
    print("\n\n")
    print("=" * 40)
